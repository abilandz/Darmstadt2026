...
**Last update**: 20260906-2

### Table of Contents

1. [Pipes **`|`** and Unix philosophy](#pipes)
2. [Examples](#examples)

### 1. Pipes **`|`** and Unix philosophy <a href="#pipes" id="pipes"></a>

We have already seen that commands can take their input directly from the user or from files. But in general, one command can take the output of another command directly as its input. This mechanism is called a _pipe_ and is a very generic concept in **Linux**.
...
Historically, it was the development of pipes that led to the **Unix philosophy** in code development, whose pillars can be summarized as follows (Doug McIlroy): 
1. Write programs that do one thing and do it well. 
2. Write programs to work together. 
3. Write programs to handle text streams, because that is a universal interface.

On a side note, we remark that it is possible to redirect simultaneously both _stdout_ and _stderr_ stream of one command into _stdin_ of another, with the slightly modified pipe operator `|&`, schematically:
...
### 2. Examples <a href="#examples" id="examples"></a>
