...
### 3. Example usage <a href="#example-usage" id="example-usage"></a>
...
For instance, let us edit in your home directory the file named `~/.bash_aliases` (any other name is perfectly fine as this is your personal file, not a special configuration file!) by adding the following two lines:
