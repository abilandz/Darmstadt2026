...
In the next section, we introduce some of the core **Linux** utilities which can be used to execute various tasks within the file system.
...
*   **du -sh** ('disk usage') : Estimate the disk space used by files and directories. For directories, the flag **-s** prints the summary size for all nested subdirectories. The flag **-h** prints the size in a human-readable format.
    ...
    471M	/home/abilandz/PH8124
    4.2M	/home/abilandz/Backup
    1.1M	/home/abilandz/examples
    ...
    
    $ du -h --max-depth=2 ${HOME} # the size of directory, differentially of its
                                  # subdirectories, and all sub-subdirectories
    471K	/home/abilandz/PH8124
    41K 	/home/abilandz/PH8124/Lecture_1
    43K 	/home/abilandz/PH8124/Lecture_2
    ...
    4.2M	/home/abilandz/Backup
    1.2M	/home/abilandz/Backup/today
    ...
